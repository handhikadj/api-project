    ...
    <div>
        ...
        >
            <v-list class="list-mar">
                ...
                <v-list-tile @click.stop="$router.push('/home')" class="">
                    <v-list-tile-action>
                ...
                <v-list-tile @click.stop="$router.push('/product')">
                    <v-list-tile-action>
                ...
                <v-divider inset dark></v-divider>
                <v-list-tile @click.stop="$router.push('/purchase')">
                    <v-list-tile-action>
                ...
                <v-divider inset dark></v-divider>
                <v-list-tile @click.stop="$router.push('/sale')">
                    <v-list-tile-action>
                ...
                <v-divider inset dark></v-divider>
                <v-list-tile @click.stop="$router.push('/inventory')">
                    <v-list-tile-action>
                        <v-icon>book</v-icon>
                    </v-list-tile-action>
